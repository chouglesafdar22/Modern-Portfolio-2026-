          ...
          <div className="grid gap-12 md:grid-cols-[1.2fr_0.8fr] lg:items-center">
            ...
            >
              ...
              <p className="mt-4 wrap-break-word text-base md:text-lg lg:text-xl text-[#F2F3FF]/70 merriweather-medium">
                Full-Stack Engineer helping startups and businesses turn ideas into modern digital products, from websites and web apps to mobile apps, SaaS platforms, and AI-powered solutions.
              </p>
