                ...
                <div className="grid items-center md:gap-10 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <p className="mt-4 lg:text-xl md:text-lg wrap-break-word text-base merriweather-medium leading-relaxed text-[#F2F3FF]/70">
                            I'm Safdar Chougle, a Full-Stack MERN Developer specializing in building modern, scalable, and user-centric web applications with React, Next.js, TypeScript, Node.js, Express.js, and MongoDB.
                        </p>

                        <p className="mt-4 lg:text-xl md:text-lg wrap-break-word text-base merriweather-medium leading-relaxed text-[#F2F3FF]/70">
                            I enjoy transforming ideas into impactful digital products while prioritizing clean architecture, performance, scalability, and exceptional user experiences.
                        </p>
                    </div>
